...
function About() {
  return (
    <div className="bg-blue-500  min-h-screen flex flex-col justify-center items-center text-white">
      <h1 className="title text-[40px] font-bold mb-6 text-left w-96 mr-60">Discover The Power Of Great Music</h1>
      <p className="title text-[15px] mb-4 text-left w-96 mr-60">
